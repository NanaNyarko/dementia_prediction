...
def save_bottlebeck_features():
    ...
    np.save(
        "oasis_cross-sectional_features_train" + "_" + data_type + ".npy",
    ...
    np.save(
        "oasis_cross-sectional_features_validation" + "_" + data_type + ".npy",
...
def train_top_model():
    ...
    np.save(
        "oasis_cross-sectional_class_indices" + "_" + data_type + ".npy",
